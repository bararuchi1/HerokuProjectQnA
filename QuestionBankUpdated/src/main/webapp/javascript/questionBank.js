...
app.value("loginUrl","basicController/getLoginDetails");
...
app.factory("serviceCallingFactory",["$http",function($http){
	var url="basicController/getLoginDetails";
	var loginResponseData={
			"demoWorkingService":function(){
				return $http({
					method:"post",
					url:"../restApi/basicController/demoPost",
					headers: {
			...
			"fetchQuestionDetails":function(data){
				return $http({
					method :"get",
					url:"../restApi/basicController/fetchQuestionDetails/"+data,
					header:{
						 'Content-Type': 'application/json'
					}
			...
			"fetchProductList":function(){
				return $http({
					method:"get",
					url:"../restApi/basicController/getProductCatagory",
					header:{
						'Content-type':'application/json'
					}
				}).then(function(response){
			...
			"insertQuestionDetails":function(data){
				...
				{
					method:"post",
					url:"../restApi/basicController/insertQnAintoDB",
